  ...
  return (
    <Page title="Guestbook" description="Leave me a message!">
      <div className={styles.headerContainer}>
        ...
        <p className={styles.description}>Leave me a message!</p>
        ...
        {session && (
          <div className={styles.formContainer}>
            <input
              ...
              value={note}
              onKeyPress={(e) => handleNoteTyping(e)}
              onChange={(e) => handleNoteTyping(e)}
            />

            <div className={styles.userContainer}>
              {note.length > 0 && (
                <p className={styles.submitNote}>Press enter to submit.</p>
              )}
              {errorMsg && <p className={styles.submitNote}>{errorMsg}</p>}
