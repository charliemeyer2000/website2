---
title: I Switched to Typescript
slug: i-switched-to-typescript
...
Something that I noticed quite quickly with TypeScript is how much I found myself going from parent to child component to check their props and ensure
I had all the necessary types. It's an incredibly small thing, but the difference between having the compiler "yell" at me and tell
...
my next(Js) projects are using TS. 
