...
- There are lots of interesting problems in RL:
    ...
    - Automating Theorem Proving using RL (lots of interesting movement occuring quickly in this space)
    - Sample efficiency
...
- I have worked in small and large teams in the industry as a software engineer. 
