...
- [x] Standard architectures 
    - Multi-layer perceptron - multi layer neural network: http://ufldl.stanford.edu/tutorial/supervised/MultiLayerNeuralNetworks/
    - [Vanilla RNN](https://karpathy.github.io/2015/05/21/rnn-effectiveness/)
